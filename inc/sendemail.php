...
define( "RECIPIENT_NAME", "rahul" );
define( "RECIPIENT_EMAIL", "ranu5200@gmail.com" );
...
$msg = isset( $_POST['message'] ) ? preg_replace( "/(From:|To:|BCC:|CC:|Subject:|Content-Type:)/", "", $_POST['message'] ) : "";
